...
export default function OricIA({ lang, setSuccessToast }: OricIAProps) {
  ...
  // Simulated Solution Synthesizer Execution
  ...
  // Chat Responses Adaptability (dynamic parsing for any domain)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-tech-cartao border border-tech-borda rounded-2xl p-5 shadow-lg space-y-4">
            ...
            <form onSubmit={handleSynthesizeSolution} className="space-y-3">
              <textarea 
